...
require (
	...
	go.opentelemetry.io/otel/sdk v1.23.1 // @grafana/backend-platform
	go.opentelemetry.io/otel/trace v1.23.1 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/otel v1.23.1 // @grafana/backend-platform
