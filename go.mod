...
require (
	cloud.google.com/go/storage v1.35.1 // @grafana/backend-platform
	...
	github.com/aws/aws-sdk-go v1.49.0 // @grafana/aws-datasources
...
require (
	...
	gocloud.dev v0.36.0 // @grafana/grafana-app-platform-squad
)
